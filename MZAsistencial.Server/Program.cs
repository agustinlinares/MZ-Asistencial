...
try
{
    Log.Information("Iniciando el servidor de MZ Asistencial...");
...
{
    // Si el servidor "peta" a nivel de infraestructura (ej. puerto ocupado), lo cazamos
    Log.Fatal(ex, "Fallo catastrófico al iniciar la aplicación");
}
finally
{
    Log.CloseAndFlush();
