...
const Descuadres = () => {
    ...
    useEffect(() => {
        ...
        const mutuaIdSesion = userData.mutuaId || userData.MutuaId || 0;
        const anio = userData.anio || userData.Anio || new Date().getFullYear();

        fetch(`${API}/Descuadres?usuarioId=${usuarioId}&mutuaIdSesion=${mutuaIdSesion}&anio=${anio}`)
            .then(res => res.json())
