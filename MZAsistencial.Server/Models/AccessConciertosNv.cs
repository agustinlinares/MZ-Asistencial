...
public partial class AccessConciertosNv
{
    public string? Idcentro { get; set; }

    public int? Ejerc { get; set; }

    public string? Numidentconc { get; set; }

    public string? Denosuje { get; set; }

    public string? Direcpost { get; set; }

    public string? Localidres { get; set; }

    public string? Provinciacon { get; set; }

    public string? Cpcon { get; set; }
    ...
    public string? VíaPública { get; set; }
    ...
    public int? Asamprimcons { get; set; }
    ...
    public int? Asamplacrad { get; set; }
    ...
    public int? Ashnprimcons { get; set; }
    ...
    public int? Ashnconsenf { get; set; }
    ...
    public int? Ashnplacrad { get; set; }
