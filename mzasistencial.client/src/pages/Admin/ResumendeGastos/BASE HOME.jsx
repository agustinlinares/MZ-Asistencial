...
const Inicio = () => {
    ...
    const schedule = [
        { time: "09:30", name: "Laura M.", type: "Visita domiciliaria", color: "#ef4444" },
        { time: "11:00", name: "Carlos D.", type: "Entrevista de evaluación", color: "#3b82f6" },
        { time: "12:30", name: "Reunión equipo", type: "Coordinación mensual", color: "#6366f1" },
        { time: "16:00", name: "Javier R.", type: "Seguimiento urgente", color: "#f59e0b" },
    ];
    return (
        <React.Fragment>
            <div className="col-xxxl-12 col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 mzh-xxxl-100 mzh-xxl-100 mzh-xl-100 mzh-md-100 mzh-sm-100 mzh-xs-100 row m-0 p-0">
                <div className="file-box" id="home-page">
                    {/* ALERT */}
                    {showAlert && (
                        <div className="alert-banner">
                            <span className="alert-icon"><i className="ri-notification-line"></i></span>
                            <span className="alert-text"><strong>2 casos urgentes</strong> requieren tu atención hoy — Javier R. lleva 48h sin contacto.</span>
                            <button role="Cerrar Alertas" type="button" className="alert-close mz-btn-links" onClick={() => setShowAlert(false)}>✕</button>
                        </div>
                    )}
                    ...
                    <div className="stats-grid">
                        {[
                            { label: "Casos activos", value: "24", icon: "ri-folder-line", trend: "+2", dir: "up", note: "vs semana pasada" },
                            { label: "Resueltos este mes", value: "38", icon: "ri-checkbox-circle-line", trend: "+12%", dir: "up", note: "vs mes anterior" },
                            { label: "Urgentes ahora", value: "5", icon: "ri-thunderstorms-line", trend: "+2", dir: "down", note: "nuevos hoy" },
                            { label: "Tiempo medio resolución", value: "8d", icon: "ri-timer-line", trend: "-1.2d", dir: "up", note: "mejora respecto anterior" },
                        ].map(s => (
                            <div key={s.label} className={`stat-card`}>
                                ...
                                <div className="stat-footer">
                                    <span className={`stat-trend ${s.dir}`}>{s.trend}</span>
                                    <span>{s.note}</span>
                                </div>
                            </div>
                        ))}
                    </div>
                    <div className="stad-cover">
                            ...
                            >
                                <Toolbar>
                                    ...
                                    <Item location="before">
                                        <span className="title-table">Mis casos asignados</span>
                                    </Item>
                        ...
                        <div className="cover-shedule">
                            {/* SCHEDULE */}
                            <div className="shedule">
                                <div className="shedule-header">
                                    <div className="shedule-title"><i className="ri-calendar-line"></i> {t('literal.agendahoy')}</div>
                                    <button type="button" className="shedule-action">{t('literal.agendaabrir')}</button>
                                </div>
                                <div className="shedule-body">
                                    {schedule.map((s, i) => (
                                        <div key={i} className="schedule-item">
                                            ...
                                            <div className="schedule-info">
                                                ...
                                                <div className="schedule-type">{s.type}</div>
                                            </div>
                                        </div>
                                    ))}
                                </div>
